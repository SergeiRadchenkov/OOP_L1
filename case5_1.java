...
public class case5_1 {
    ...
    static {
        case5_1.number = 0;
        case5_1.r = new Random();
    }

    public case5_1(String name, int hp, int elixir) {
        this.name = name;
        this.hp = hp;
        this.maxHp = hp;
        this.elixir = elixir;
    ...
    public case5_1() {
        this(String.format(HERO_PRIEST_D, ++case5_1.number),
        case5_1.r.nextInt(100, 200),
        case5_1.r.nextInt(50, 150));
    }

    public int Attack() {
        int damage = case5_1.r.nextInt(20, 30);
